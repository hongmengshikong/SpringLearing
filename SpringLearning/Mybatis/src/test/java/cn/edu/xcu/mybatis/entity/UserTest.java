...
public class UserTest  {
    ...
    public void testFindUserByNameAndPass(){
        ...
        System.out.println(user);
        User user2=userMapper.findUserByUsernameAndPassword("zhangsan'#","1234");
        System.out.println(user2);
    }
    @Test
    public void testFindUserByNameAndPass2(){
        User user=userMapper.findUserByUsernameAndPassword2("zhangsan","123456");
        System.out.println(user);
        User user2=userMapper.findUserByUsernameAndPassword2("zhangsan'#","1234");
        System.out.println(user2);
    }
    @Test
